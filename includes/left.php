<div class="profile bgcolor-green noPrint">
	<div class="profile-img">
		<img src="<?= $configSite?><?=$themePathSite?>/images/users/matheus.jpg" alt="Imagem do Usuário" title="Imagem do Usuário">
	</div>	
</div>

<div class="users bgcolor-green noPrint">
	<p class="font-text-sub text-center color-white">Matheus Henrique de Deus</p>
</div>
