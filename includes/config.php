<?php
$_SESSION['user'] = 'Matheus Henrique';
...
$mailSite = "matheusdeus@unipam.edu.br"; //E-mail do Cliente ou Dono da Aplicação
...
$nameAuthorSite = "Grupo Projeto Integrador"; //Nome do Autor
$mainAuthorSite = "matheusdeus@unipam.edu.br"; //E-mail do Autor
